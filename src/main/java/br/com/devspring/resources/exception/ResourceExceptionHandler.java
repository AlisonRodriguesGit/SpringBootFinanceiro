...
@ControllerAdvice
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler { //A classe ResponseEntityExceptionHandler trata a granfe maioria das exception
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(),"Fields Validation Error", System.currentTimeMillis(), ex.getClass().getName(),fields, fieldMessages);
